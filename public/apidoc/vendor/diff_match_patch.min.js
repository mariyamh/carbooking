(function () {
  ...
  diff_match_patch.prototype.diff_main = function (a, b, c, d) {
    ...
    const g = a.substring(a.length - f);
  ...
  diff_match_patch.prototype.diff_compute_ = function (a, b, c, d) {
    if (!a) return [[1, b]];
    if (!b) return [[-1, a]];
    let e = a.length > b.length ? a : b;
    let f = a.length > b.length ? b : a;
    let g = e.indexOf(f);
    return g != -1
      ? ((c = [
          [1, e.substring(0, g)],
  ...
  diff_match_patch.prototype.diff_lineMode_ = function (a, b, c) {
    let d = this.diff_linesToChars_(a, b);
    a = d.chars1;
    b = d.chars2;
    d = d.lineArray;
    ...
    a.push([0, '']);
    for (let e = (d = b = 0), f = '', g = ''; b < a.length; ) {
      switch (a[b][0]) {
        case 1:
          e++;
          g += a[b][1];
  ...
  diff_match_patch.prototype.diff_halfMatch_ = function (a, b) {
    function c(a, b, c) {
      for (
        ...
        const m = f.diff_commonPrefix(a.substring(c), b.substring(e));
        const s = f.diff_commonSuffix(a.substring(0, c), b.substring(0, e));
        g.length < s + m &&
  ...
  diff_match_patch.prototype.match_bitap_ = function (a, b, c) {
    ...
    var h = a.indexOf(b, c);
    h != -1 &&
      ((g = Math.min(d(0, h), g)), (h = a.lastIndexOf(b, c + b.length)), h != -1 && (g = Math.min(d(0, h), g)));
    for (var j = 1 << (b.length - 1), h = -1, i, k, q = b.length + a.length, r, t = 0; t < b.length; t++) {
      ...
      q = k;
      i = Math.max(1, c - k + 1);
      let p = Math.min(c + k, a.length) + b.length;
      k = Array(p + 2);
      for (k[p + 1] = (1 << t) - 1; p >= i; p--) {
        let w = e[a.charAt(p - 1)];
        k[p] =
  ...
  diff_match_patch.prototype.patch_deepCopy = function (a) {
    for (var b = [], c = 0; c < a.length; c++) {
      const d = a[c];
      const e = new diff_match_patch.patch_obj();
      e.diffs = [];
      for (let f = 0; f < d.diffs.length; f++) e.diffs[f] = d.diffs[f].slice();
      e.start1 = d.start1;
      e.start2 = d.start2;
      e.length1 = d.length1;
      e.length2 = d.length2;
  ...
  diff_match_patch.prototype.patch_apply = function (a, b) {
    ...
    const c = this.patch_addPadding(a);
    b = c + b + c;
  ...
  diff_match_patch.prototype.patch_fromText = function (a) {
    ...
    for (let c = 0, d = /^@@ -(\d+),?(\d*) \+(\d+),?(\d*) @@$/; c < a.length; ) {
      ...
      const f = new diff_match_patch.patch_obj();
      b.push(f);
