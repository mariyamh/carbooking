...
})(
  {
    1: [
      function (a, b, c) {
        !(function (c, d) {
          const e = c.document;
          const f = a('./src/utils/get-by-class');
          const g = a('./src/utils/extend');
          const h = a('./src/utils/index-of');
          const i = a('./src/utils/events');
          const j = a('./src/utils/to-string');
          const k = a('./src/utils/natural-sort');
          const l = a('./src/utils/classes');
          const m = a('./src/utils/get-attribute');
          const n = a('./src/utils/to-array');
          var o = function (b, c, p) {
            let q;
            const r = this;
            const s = a('./src/item')(r);
            const t = a('./src/add-async')(r);
            (q = {
              start() {
                (r.listClass = 'list'),
                  ...
                  r.utils.extend(r, c),
                  (r.listContainer = typeof b === 'string' ? e.getElementById(b) : b),
                  r.listContainer &&
              ...
              handlers() {
                for (const a in r.handlers) r[a] && r.on(a, r[a]);
              },
              items() {
              ...
              (this.off = function (a, b) {
                const c = r.handlers[a];
                const d = h(c, b);
                return d > -1 && c.splice(d, 1), r;
              }),
              (this.trigger = function (a) {
                for (let b = r.handlers[a].length; b--; ) r.handlers[a][b](r);
                return r;
              }),
              (this.reset = {
                filter() {
                  for (let a = r.items, b = a.length; b--; ) a[b].filtered = !1;
                  return r;
                },
                search() {
                  for (let a = r.items, b = a.length; b--; ) a[b].found = !1;
                  return r;
                },
              }),
          ...
          return (
            ...
            function (b) {
              if ((a.trigger('filterStart'), (a.i = 1), a.reset.filter(), void 0 === b)) a.filtered = !1;
                ...
                a.filtered = !0;
                for (let c = a.items, d = 0, e = c.length; d < e; d++) {
                  const f = c[d];
          ...
          return function (b, c, d) {
            ...
            const f = function (b, c, d) {
              if (void 0 === c) d ? e.values(b, d) : e.values(b);
                ...
                e.elm = c;
                const f = a.templater.get(e, b);
                e.values(f);
              }
            };
            (this.values = function (b, c) {
              if (void 0 === b) return e._values;
              for (const d in b) e._values[d] = b[d];
    ...
    5: [
      function (a, b, c) {
        b.exports = function (b) {
          ...
          const e = function (a, d) {
            for (let e = 0, f = a.length; e < f; e++) b.items.push(new c(d, a[e]));
          };
          var f = function (a, c) {
            const d = a.splice(0, 50);
            e(d, c),
              a.length > 0
                ? setTimeout(() => {
                    f(a, c);
      ...
      function (a, b, c) {
        b.exports = function (a) {
          ...
          var f = {
            ...
            setOptions(a) {
              a.length == 2 && a[1] instanceof Array
                ? (c = a[1])
                : a.length == 2 && typeof a[1] === 'function'
                ? ((c = void 0), (e = a[1]))
                : a.length == 3
                ? ((c = a[1]), (e = a[2]))
                : (c = void 0);
            ...
            toArray(a) {
              const b = [];
              for (const c in a) b.push(c);
              return b;
            },
          };
          var g = {
            list() {
              for (let b = 0, c = a.items.length; b < c; b++) g.item(a.items[b]);
            },
            item(a) {
              a.found = !1;
              for (let b = 0, d = c.length; b < d; b++) if (g.values(a.values(), c[b])) return void (a.found = !0);
            },
            values(c, e) {
              return !!(
          ...
          return (
            ...
            a.utils.events.bind(a.utils.getByClass(a.listContainer, a.searchClass), 'keyup', (b) => {
              const c = b.target || b.srcElement;
              const d = c.value === '' && !a.searched;
              d || h(c.value);
            }),
            a.utils.events.bind(a.utils.getByClass(a.listContainer, a.searchClass), 'input', (a) => {
      ...
      function (a, b, c) {
        b.exports = function (a) {
          a.sortFunction =
            ...
            function (b, c, d) {
              return (
                (d.desc = d.order == 'desc'), a.utils.naturalSort(b.values()[d.valueName], c.values()[d.valueName], d)
              );
            };
          var b = {
            els: void 0,
            clear() {
              for (let c = 0, d = b.els.length; c < d; c++)
                a.utils.classes(b.els[c]).remove('asc'), a.utils.classes(b.els[c]).remove('desc');
            },
            getOrder(b) {
              const c = a.utils.getAttribute(b, 'data-order');
              return c == 'asc' || c == 'desc'
                ? c
            ...
            getInSensitive(b, c) {
              const d = a.utils.getAttribute(b, 'data-insensitive');
              d === 'false' ? (c.insensitive = !1) : (c.insensitive = !0);
            },
            setOrder(c) {
              for (let d = 0, e = b.els.length; d < e; d++) {
                const f = b.els[d];
                if (a.utils.getAttribute(f, 'data-sort') === c.valueName) {
                  const g = a.utils.getAttribute(f, 'data-order');
                  g == 'asc' || g == 'desc'
          ...
          const c = function () {
            a.trigger('sortStart');
            let c = {};
            const d = arguments[0].currentTarget || arguments[0].srcElement || void 0;
            d
              ...
              : ((c = arguments[1] || c),
                ...
                (c.order = c.order || 'asc'),
                (c.insensitive = typeof c.insensitive === 'undefined' || c.insensitive)),
              b.clear(),
              b.setOrder(c),
              (c.sortFunction = c.sortFunction || a.sortFunction),
              a.items.sort((a, b) => {
                const d = c.order === 'desc' ? -1 : 1;
        ...
        const d = function (a) {
          ...
          (this.clearSourceItem = function (b, c) {
            for (let d = 0, e = c.length; d < e; d++) {
              var f;
              if (c[d].data)
                for (let g = 0, h = c[d].data.length; g < h; g++) b.setAttribute(`data-${c[d].data[g]}`, '');
              else {
                c[d].attr && c[d].name
            ...
            (this.getItemSource = function (b) {
              if (void 0 === b) {
                for (let c = a.list.childNodes, d = 0, e = c.length; d < e; d++)
                ...
                const h = document.getElementById(a.item);
                if (h) return h;
              }
            }),
            (this.get = function (b, d) {
              ...
              for (var e = {}, f = 0, g = d.length; f < g; f++) {
                var h;
                if (d[f].data)
                  for (let i = 0, j = d[f].data.length; i < j; i++)
            ...
            (this.set = function (b, d) {
              const e = function (b) {
                for (let c = 0, d = a.valueNames.length; c < d; c++) {
                  if (a.valueNames[c].data) {
                    for (let e = a.valueNames[c].data, f = 0, g = e.length; f < g; f++)
      ...
      function (a, b, c) {
        ...
        (b.exports = function (a) {
          ...
          (d.prototype.remove = function (a) {
            if (g.call(a) == '[object RegExp]') return this.removeMatching(a);
          ...
          (d.prototype.removeMatching = function (a) {
            for (let b = this.array(), c = 0; c < b.length; c++) a.test(b[c]) && this.remove(b[c]);
            return this;
          }),
          (d.prototype.toggle = function (a, b) {
            return this.list
              ? (typeof b !== 'undefined' ? b !== this.list.toggle(a, b) && this.list.toggle(a) : this.list.toggle(a),
                this)
              : (typeof b !== 'undefined'
                  ? b
                    ? this.add(a)
          ...
          (d.prototype.array = function () {
            const a = this.el.getAttribute('class') || '';
            const b = a.replace(/^\s+|\s+$/g, '');
            const c = b.split(f);
    ...
    10: [
      function (a, b, c) {
        const d = window.addEventListener ? 'addEventListener' : 'attachEvent';
        const e = window.removeEventListener ? 'removeEventListener' : 'detachEvent';
        const f = d !== 'addEventListener' ? 'on' : '';
        const g = a('./to-array');
        (c.bind = function (a, b, c, e) {
          a = g(a);
          for (let h = 0; h < a.length; h++) a[h][d](f + b, c, e || !1);
        }),
          (c.unbind = function (a, b, c, d) {
            a = g(a);
            for (let h = 0; h < a.length; h++) a[h][e](f + b, c, d || !1);
          });
      },
      { './to-array': 16 },
    ],
    ...
    12: [
      function (a, b, c) {
        b.exports = function (a, b) {
          let c = (a.getAttribute && a.getAttribute(b)) || null;
          if (!c)
            for (let d = a.attributes, e = d.length, f = 0; f < e; f++)
        ...
        b.exports = (function () {
          return document.getElementsByClassName
            ...
            : function (a, b, c) {
                ...
                a === null && (a = document);
                for (
                  let f = a.getElementsByTagName(e), g = f.length, h = new RegExp(`(^|\\s)${b}(\\s|$)`), i = 0, j = 0;
                  i < g;
                  i++
                ) {
    ...
    15: [
      function (a, b, c) {
        b.exports = function (a, b, c) {
          let d;
          let e;
          const f = /(^([+\-]?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?(?=\D|\s|$))|^0x[\da-fA-F]+$|\d+)/g;
          const g = /^\s+|\s+$/g;
          const h = /\s+/g;
          const i =
          ...
          const n = m(a);
          const o = m(b);
          const p = n.replace(f, '\0$1\0').replace(/\0$/, '').replace(/^\0/, '').split('\0');
          const q = o.replace(f, '\0$1\0').replace(/\0$/, '').replace(/^\0/, '').split('\0');
          const r = parseInt(n.match(j), 16) || (p.length !== 1 && Date.parse(n));
          const s = parseInt(o.match(j), 16) || (r && o.match(i) && Date.parse(o)) || null;
          const t = function (a, b) {
            return ((!a.match(k) || b == 1) && parseFloat(a)) || a.replace(h, ' ').replace(g, '') || 0;
          };
          if (s) {
            if (r < s) return -1;
            if (r > s) return 1;
          }
          for (let u = 0, v = p.length, w = q.length, x = Math.max(v, w); u < x; u++) {
            if (((d = t(p[u] || '', v)), (e = t(q[u] || '', w)), isNaN(d) !== isNaN(e))) return isNaN(d) ? 1 : -1;
            if (/[^\x00-\x80]/.test(d + e) && d.localeCompare) {
              const y = d.localeCompare(e);
              return y / Math.abs(y);
            }
            if (d < e) return -1;
            if (d > e) return 1;
    ...
    16: [
      function (a, b, c) {
        ...
        b.exports = function (a) {
          ...
          if (typeof a === 'function' && a instanceof Function) return [a];
    ...
    17: [
      function (a, b, c) {
        b.exports = function (a) {
          return (a = void 0 === a ? '' : a), (a = a === null ? '' : a), (a = a.toString());
        };
      },
      {},
    ],
