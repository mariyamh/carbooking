                ...
                for (
                  ...
                  if (!(b instanceof W)) {
                    ...
                    if (h && y != t.tail.prev) {
                      ...
                      for (let E = y; E !== t.tail && (S < P || typeof E.value === 'string'); E = E.next)
                        x++, (S += E.value.length);
                    ...
                    if (w) {
                      ...
                      (y = I(t, C, _)),
                        N && I(t, y, N),
                        x > 1 && e(n, t, r, y.prev, k, { cause: `${o},${u}`, reach: j });
                    }
                  }
                }
              }
...
!(function (s) {
  ...
  const n = 'bool byte char decimal double dynamic float int long object sbyte short string uint ulong ushort var void';
  const r = 'class enum interface struct';
  const i =
  ...
  const R = '\\b(?:assembly|event|field|method|module|param|property|return|type)\\b';
  const P = a('<<0>>(?:\\s*\\(<<1>>*\\))?', [m, E]);
  s.languages.insertBefore('csharp', 'class-name', {
    attribute: {
