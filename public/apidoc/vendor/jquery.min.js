...
!(function (e, t) {
  ...
  function Pe(n, r, i, o) {
    ...
    if (
      f &&
      ((t = (e = xe(r, n[0].ownerDocument, !1, n, o)).firstChild), e.childNodes.length === 1 && (e = t), t || o)
    ) {
    ...
    (S.cssHooks.marginLeft = $e(y.reliableMarginLeft, (e, t) => {
      if (t) {
        return `${
          ...
          e.getBoundingClientRect().left - We(e, { marginLeft: 0 }, () => e.getBoundingClientRect().left)
        }px`;
      }
    })),
          ...
          this.each(function (e) {
            ...
            this.nodeType === 1 &&
              ((t = i ? n.call(this, e, S(this).val()) : n) == null
                ...
                : typeof t === 'number'
                ? (t += '')
                : Array.isArray(t) && (t = S.map(t, (e) => (e == null ? '' : `${e}`))),
    ...
    (S.offset = {
      setOffset(e, t, n) {
        ...
        l === 'static' && (e.style.position = 'relative'),
          ...
          'using' in t
            ? t.using.call(e, f)
            : (typeof f.top === 'number' && (f.top += 'px'), typeof f.left === 'number' && (f.left += 'px'), c.css(f));
      },
    }),
    S.fn.extend({
      offset(t) {
